...
session_start();
                ...
                if ($_SESSION['log'] != "ativo")
                  ...
                  $sqlconsulta="SELECT * FROM cadastro_usu ORDER BY nome";
            ...
            <div class="left">
              ...
              <main class="cards">
                ...
                <h3><?php echo $dados["nome"]; ?></h3>
                  ...
                  <div>
                    <a class='btn-sm btn-danger' href="delete-usuario.php?id=<?php echo $dados['id'];  ?>" title='Deletar'>
...
<!--
            ...
            <div class="right">
              <img src="assets/img/usuarios.svg" alt="Person Image" class="person" />
            </div>
          </div>
        </div>
