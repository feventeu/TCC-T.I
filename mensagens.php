...
session_start();
                ...
                if ($_SESSION['log'] != "ativo")
                  ...
                  $sqlconsulta="SELECT * FROM mensagem ORDER BY nome";
...
<html lang="en">
  <head>
    ...
    <title>Adopt Me | Mensagens</title>
            ...
            <div class="left">
              ...
              <main class="cards">
                ...
                <h3><?php echo $dados["nome"]; ?></h3>
                  <span>Cidade: <?php echo $dados["cidade"]; ?></span>
                  <span>Telefone: <?php echo $dados["telefone"]; ?></span>
                  <span>CPF: <?php echo $dados["cpf"]; ?></span>
                  <span>Renda: <?php echo $dados["cpf"]; ?></span>
                  <span>Pet: <?php echo $dados["pet"]; ?></span>
                  <div>
                    <a class='btn-sm btn-danger' href="delete-mensagem.php?id=<?php echo $dados['id'];  ?>" title='Deletar'>
...
<!--
            ...
            <div class="right">
              <img src="assets/img/mensagem.svg" alt="Person Image" class="person" />
            </div>
          </div>
        </div>
